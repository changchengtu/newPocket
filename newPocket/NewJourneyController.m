...
- (IBAction)pressDownButton:(id)sender {
    ...
    if (db != nil) {
        // 準備好插入資料的SQL command
        NSString *queryString = [NSString stringWithFormat:@"INSERT INTO journey VALUES ( NULL, '%@','%@',NULL, NULL,NULL, NULL,NULL,0)", self.journeyNameField.text, self.JourneyLocationField.text];
